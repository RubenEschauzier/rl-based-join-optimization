...
def run_training_policy_gradient(queries_location, rdf2vec_vector_location, endpoint_uri,
    ...
    model_factory = ModelFactory("experiments/configs/graph_embedding_model.yaml")
