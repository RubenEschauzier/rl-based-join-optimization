...
from src.models.sb3_feature_extractor import MaskableQRDQNPolicy
...
class MaskableQRDQN(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            current_quantiles = self.quantile_net(replay_data.observations, action_masks=replay_data.action_masks)
