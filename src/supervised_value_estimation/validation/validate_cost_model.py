...
from src.supervised_value_estimation.agents.CostEstimatorAgent import CostEstimatorAgent
...
def build_cost_agent(model_kwargs, precomputed_indexes, precomputed_masks, device):
    heads_config = {
        'plan_cost': {
    ...
    agent = CostEstimatorAgent(epinet_cost_estimation, precomputed_indexes, precomputed_masks, head_name="plan_cost")
    return agent

def run_validation(model_kwargs, locations_dict):
...
if __name__ == "__main__":
    ...
    run_validation(model_kwargs_dict, locations)